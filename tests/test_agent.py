...
def test_get_prediction_statistics_success(monkeypatch):
    ...
    monkeypatch.setattr(httpx, "get", lambda url, params=None, timeout=None: FakeResponse(200, payload))
...
def test_get_prediction_statistics_backend_down(monkeypatch):
    def raise_connect_error(url, params=None, timeout=None):
...
def test_get_prediction_statistics_http_500(monkeypatch):
    monkeypatch.setattr(httpx, "get", lambda url, params=None, timeout=None: FakeResponse(500))
...
def test_get_prediction_by_id_not_found(monkeypatch):
    monkeypatch.setattr(httpx, "get", lambda url, params=None, timeout=None: FakeResponse(404))
